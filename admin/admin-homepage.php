<?php
    ...
    include("../controllers/php/db.php");
    ...
    //fecthing data  from data of each canidate
    $row_user=fetchdata("users","id",$_GET["id"]);
        $row_user_details=fetchdata("user_details","user_id",$_GET["id"]);
        $result=fetchdata2("acadamic_qualification","user_id",$_GET["id"]);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
        <div class="row mt-3">
           ...
           <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3"> <img src="../images/logo.png" style="width:170px; height:200;"></div>
